...
(function() {
    tinymce.create("tinymce.plugins.AdamDehavenPerfectPullquotes", {
        ...
        init : function(ed, url) {
            ...
            ed.addButton("pullquote-menu", {
                ...
                size : 'small',
                menu : [
                    {text: 'Left-Aligned', onclick: function() {ed.execCommand('perfectquote-left'); }},
    ...
    // Register plugin
    tinymce.PluginManager.add("gik25_quotes", tinymce.plugins.AdamDehavenPerfectPullquotes);
})();
