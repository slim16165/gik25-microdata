<?php
	 ...
	 */
	abstract class LowLevelShortcodes {
		public static function register() {
			...
			$compatibility               = LowLevelShortcodeHelperLoader::loadModel( 'Common/Compatibility' );
		...
		private static function runShortcode( $shortcodeName, $lowLevel, $atts, $content ) {
			...
			// Print the shortcode.
			$model = LowLevelShortcodeHelperLoader::loadModel( 'Shortcode/' . $shortcodeName, $atts, $content );
			return LowLevelShortcodeHelperLoader::printTemplateOffScreen( 'Shortcode/' . $shortcodeName, $model );
		}
		/**
