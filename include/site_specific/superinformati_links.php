...
function GetListOfMed1(): Collection
{
...
function GetListOfMed2(): Collection
{
    $collection = new Collection();
...
function GetListOfMed3(): Collection
{
    $collection = new Collection();
...
function GetListOfMed4(): Collection
{
    $collection = new Collection();
...
function GetListOfMed5(): Collection
{
    $collection = new Collection();
...
function GetListOfDimagrimentoLinks(): array
{
    return [
        [
...
function GetListOfVitamins(): array
{
    return [
        [
...
function getListOfTatooLinks(): array
{
    return [
        [
...
function getListOfDietLinks(): array
{
    $links_data = [
...
function getSediInpsLinkCollection(): Collection
{
    $collection = new Collection();
