...
class Analysis_Service_Factory {
	 ...
	 * MODIFIED: Use local analysis service instead of cloud service
	 */
	public static function get_instance( $post_id ) {
		// Use local analysis service (Wikidata-based) instead of cloud service
		return Local_Analysis_Service::get_instance();
	}
}
