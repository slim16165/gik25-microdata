...
(function($, settings) {
  $(function($) {
     ...
     */
    const bind = function() {
      // MODIFIED: Local mode - key validation disabled, always mark as valid
      $('input[data-wl-key]').on('keyup', function() {
        ...
        $this.removeClass('untouched invalid');
        
        // In local mode, always mark as valid and show Next button
        delay($this, function() {
          $this.addClass('valid');
