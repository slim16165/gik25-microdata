...
class MyNav_Menu extends Base_Widget
{
    ...
    {
        return __('My Nav Menu', 'elementor-pro');
    }
    ...
    protected function render()
    {
        ...
        <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container" role="navigation"
             aria-hidden="true"><?php echo $dropdown_menu_html; ?></nav>
        <?php
    }
...
//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \MyNav_Menu() );
